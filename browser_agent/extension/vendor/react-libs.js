// Consolidated shared React libs (canonical: options deps)
// Duplicate declarations removed by selecting a single source bundle.
// Auto-generated on 2025-09-27.
...
function requireReact_production_min() {
  ...
  var l = Symbol.for("react.element"), n = Symbol.for("react.portal"), p = Symbol.for("react.fragment"), q = Symbol.for("react.strict_mode"), r2 = Symbol.for("react.profiler"), t3 = Symbol.for("react.provider"), u = Symbol.for("react.context"), v = Symbol.for("react.forward_ref"), w = Symbol.for("react.suspense"), x = Symbol.for("react.memo"), y = Symbol.for("react.lazy"), z = Symbol.iterator;
  function A(a) {
...
function requireReact() {
  ...
  hasRequiredReact = 1;
  {
    react.exports = requireReact_production_min();try{(globalThis||window||self).React=react.exports;}catch(_){ };
  }
...
function requireScheduler_production_min() {
  ...
  (function(exports) {
    ...
    var r2 = [], t3 = [], u = 1, v = null, y = 3, z = false, A = false, B = false, D = "function" === typeof setTimeout ? setTimeout : null, E = "function" === typeof clearTimeout ? clearTimeout : null, F = "undefined" !== typeof setImmediate ? setImmediate : null;
    "undefined" !== typeof navigator && void 0 !== navigator.scheduling && void 0 !== navigator.scheduling.isInputPending && navigator.scheduling.isInputPending.bind(navigator.scheduling);
    function G(a) {
      for (var b = h(t3); null !== b; ) {
        if (null === b.callback) k(t3);
        else if (b.startTime <= a) k(t3), b.sortIndex = b.expirationTime, f(r2, b);
        else break;
        b = h(t3);
      }
    }
    ...
    exports.unstable_scheduleCallback = function(a, b, c) {
      ...
      c > d ? (a.sortIndex = c, f(t3, a), null === h(r2) && a === h(t3) && (B ? (E(L), L = -1) : B = true, K(H, c - d))) : (a.sortIndex = e, f(r2, a), A || z || (A = true, I(J)));
      return a;
    };
    ...
    Jb(function() {
      ...
      a: {
        ...
        if (void 0 !== h2) {
          ...
          0 < t3.length && (h2 = new k2(h2, n, null, c, e2), g2.push({ event: h2, listeners: t3 }));
        }
      }
      if (0 === (b & 7)) {
        a: {
          ...
          if (k2 || h2) {
            ...
            if (k2 !== n) {
              ...
              J = null == k2 ? h2 : ue(k2);
              u = null == n ? h2 : ue(n);
              h2 = new t3(F, w + "leave", k2, c, e2);
              h2.target = J;
              h2.relatedTarget = u;
              F = null;
              Wc(e2) === d2 && (t3 = new t3(x, w + "enter", n, c, e2), t3.target = u, t3.relatedTarget = J, F = t3);
              J = F;
              if (k2 && n) b: {
                t3 = k2;
                x = n;
  ...
  function Og(a) {
    ...
    function t3(e2, g2, h2, k2) {
      ...
      for (var u = l2 = null, m2 = g2, w = g2 = 0, x = null, n2 = h2.next(); null !== m2 && !n2.done; w++, n2 = h2.next()) {
        ...
        var t4 = r2(e2, m2, n2.value, k2);
        if (null === t4) {
          null === m2 && (m2 = x);
          break;
        }
        a && m2 && null === t4.alternate && b(e2, m2);
        g2 = f(t4, g2, w);
    ...
    for (V = b; null !== V; ) if (b = V, a = b.child, 0 !== (b.subtreeFlags & 1028) && null !== a) a.return = b, V = a;
      ...
      try {
        ...
        if (0 !== (b.flags & 1024)) switch (b.tag) {
          ...
          case 1:
            if (null !== n) {
              var t3 = n.memoizedProps, J = n.memoizedState, x = b.stateNode, w = x.getSnapshotBeforeUpdate(b.elementType === b.type ? t3 : Ci(b.type, t3), J);
...
function requireReactDom() {
  ...
  {
    checkDCE();
    reactDom.exports = requireReactDom_production_min();try{(globalThis||window||self).reactDom=reactDom.exports;(globalThis||window||self).ReactDOM=reactDom.exports;}catch(_){};
  }
...
function r(e) {
  ...
  if ("string" == typeof e || "number" == typeof e) n += e;
    ...
    var o = e.length;
    for (t3 = 0; t3 < o; t3++) e[t3] && (f = r(e[t3])) && (n && (n += " "), n += f);
  } else for (f in e) e[f] && (n && (n += " "), n += f);
  return n;
}
function clsx() {
  for (var e, t3, f = 0, n = "", o = arguments.length; f < o; f++) (e = arguments[f]) && (t3 = r(e)) && (n && (n += " "), n += t3);
  return n;
}
...
function withSuspense(Component, SuspenseComponent) {
  return function WithSuspense(props) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: SuspenseComponent, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component, __spreadValues$7({}, props)) });
  };
}
...
function withErrorBoundary(Component2, ErrorComponent) {
  return function WithErrorBoundary(props) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { fallback: ErrorComponent, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component2, __spreadValues$6({}, props)) });
  };
}
...
/* ===== ESM facade for React libs (exports for named imports) ===== */
const React_ = (typeof react !== 'undefined' && react.exports) ? react.exports : (globalThis.React || {});
const ReactDOM_ = (typeof reactDom !== 'undefined' && reactDom.exports) ? reactDom.exports : (globalThis.ReactDOM || globalThis.reactDom);
const jsxRuntime_ = (typeof jsxRuntimeExports !== 'undefined') ? jsxRuntimeExports : {};
const client_ = (typeof client !== 'undefined') ? client : {};
const getDefaultConfig_ =
  (typeof getDefaultConfig !== 'undefined')
    ? getDefaultConfig
    : (globalThis.getDefaultConfig || undefined);

const jsx = jsxRuntime_.jsx;
const jsxs = jsxRuntime_.jsxs;
const Fragment = jsxRuntime_.Fragment || React_.Fragment;
const StrictMode = React_.StrictMode;
const createElement = React_.createElement;

const createRoot = client_.createRoot;
const hydrateRoot = client_.hydrateRoot;


export {
  React_ as React,
  ReactDOM_ as ReactDOM,
  ReactDOM_ as reactDom,
  getDefaultConfig_ as getDefaultConfig,
  jsx, jsxs, Fragment, StrictMode, createElement, createRoot, hydrateRoot,

};
/* ===== End ESM facade ===== */


/* ===== Global exposure shim for custom bundles ===== */
(function(){
  var g = (typeof globalThis !== 'undefined') ? globalThis : (typeof window !== 'undefined' ? window : self);
  try { if (typeof g.react === "undefined" && typeof react !== "undefined") g.react = react; } catch(_){}
  try { if (typeof g.reactDom === "undefined" && typeof reactDom !== "undefined") g.reactDom = reactDom; } catch(_){}
  try { if (typeof g.client === "undefined" && typeof client !== "undefined") g.client = client; } catch(_){}
  try { if (typeof g.jsxRuntimeExports === "undefined" && typeof jsxRuntimeExports !== "undefined") g.jsxRuntimeExports = jsxRuntimeExports; } catch(_){}

  try { if (typeof g.React === "undefined" && typeof react !== "undefined" && react && react.exports) g.React = react.exports; } catch(_){}
  try { if (typeof g.ReactDOM === "undefined" && typeof reactDom !== "undefined" && reactDom && reactDom.exports) g.ReactDOM = reactDom.exports; } catch(_){}

  // Factories used by custom 'require*' wrappers in the app bundles
  try { if (typeof g.requireReact_production_min === "undefined" && typeof requireReact_production_min === "function") g.requireReact_production_min = requireReact_production_min; } catch(_){}
  try { if (typeof g.requireReactDom_production_min === "undefined" && typeof requireReactDom_production_min === "function") g.requireReactDom_production_min = requireReactDom_production_min; } catch(_){}
  try { if (typeof g.requireReactJsxRuntime_production_min === "undefined" && typeof requireReactJsxRuntime_production_min === "function") g.requireReactJsxRuntime_production_min = requireReactJsxRuntime_production_min; } catch(_){}
})();
/* ===== End shim ===== */


/* ===== Additional factory exposure (scheduler) ===== */
(function(){
  try {
    var g = (typeof globalThis !== 'undefined') ? globalThis : (typeof window !== 'undefined' ? window : self);
    if (typeof g.requireScheduler_production_min === "undefined" && typeof requireScheduler_production_min === "function") {
      g.requireScheduler_production_min = requireScheduler_production_min;
    }
  } catch(_) {}
})();
