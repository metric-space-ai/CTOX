...
fn create_channel_sync_tool() -> ToolSpec {
    ...
    properties.insert(
        "db".to_string(),
        JsonSchema::String {
            description: Some("Optional absolute path to the CTOX communication SQLite database.".to_string()),
        },
    );
    properties.insert(
        "limit".to_string(),
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Sync one external channel adapter into the shared CTOX communication SQLite store.".to_string(),
        strict: false,
        defer_loading: None,
        parameters: JsonSchema::Object {
            properties,
...
fn create_channel_ack_tool() -> ToolSpec {
    ...
    properties.insert(
        ...
        JsonSchema::Array {
            description: Some("Message keys to mark as handled or otherwise acknowledged.".to_string()),
            items: Box::new(JsonSchema::String { description: None }),
        },
    );
    properties.insert(
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Acknowledge previously leased channel messages in the shared CTOX communication store.".to_string(),
        strict: false,
        defer_loading: None,
        parameters: JsonSchema::Object {
            properties,
...
fn create_channel_send_tool() -> ToolSpec {
    ...
    properties.insert(
        "channel".to_string(),
        JsonSchema::String {
            description: Some("Outbound channel target. Supported values: tui, email, jami.".to_string()),
        },
    );
    properties.insert(
        "account_key".to_string(),
        JsonSchema::String {
            description: Some("Stable local account key, for example email:me@example.com or jami:abcdef.".to_string()),
        },
    );
    properties.insert(
    ...
    properties.insert(
        ...
        JsonSchema::String {
            description: Some("Optional sender address or account identifier override.".to_string()),
        },
    );
    properties.insert(
        "db".to_string(),
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Send an outbound message through the CTOX channel router for tui, email, or jami.".to_string(),
        strict: false,
        defer_loading: None,
        parameters: JsonSchema::Object {
            properties,
...
fn create_context_retrieve_tool() -> ToolSpec {
    ...
    properties.insert(
        "query".to_string(),
        JsonSchema::String {
            description: Some("Optional free-text query used by search and forgotten modes.".to_string()),
        },
    );
    properties.insert(
    ...
    properties.insert(
        "messages".to_string(),
        JsonSchema::Boolean {
            description: Some("Whether expand mode should also include underlying messages.".to_string()),
        },
    );
    properties.insert(
        "token_cap".to_string(),
