...
const source = readFileSync(resolve(root, 'src/core/rxdb/tests/fixtures/ctox_execution_contract.json'), 'utf8');
...
const rustPrimitive = { string: 'String', bool: 'bool', u32: 'u32', u64: 'u64' };
const tsPrimitive = { string: 'string', bool: 'boolean', u32: 'number', u64: 'number' };
const schemaPrimitive = {
  string: 'Schema.String', bool: 'Schema.Boolean',
...
const outputs = [
  [resolve(root,'src/core/sync/src/contracts.generated.rs'),rust],
  [resolve(root,'src/core/sync/contracts/ctox-sync.generated.ts'),ts],
  [resolve(root,'src/core/sync/contracts/ctox-sync.schema.generated.ts'),schemas],
];
...
console.log(`CHECK ${outputs.length} execution contracts ${process.argv.includes('--check') ? 'verified' : 'generated'} from ${hash}`);
