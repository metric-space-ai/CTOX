...
pub enum CodexErr {
    ...
    #[error("ctox-linux-sandbox was required but not provided")]
...
impl CodexErr {
    ...
    pub fn to_ctox_protocol_error(&self) -> CodexErrorInfo {
        match self {
    ...
    pub fn to_error_event(&self, message_prefix: Option<String>) -> ErrorEvent {
        ...
        ErrorEvent {
            message,
            codex_error_info: Some(self.to_ctox_protocol_error()),
        }
    }
