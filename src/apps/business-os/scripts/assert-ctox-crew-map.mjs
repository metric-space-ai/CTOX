...
function harnessHtml() {
  return `<!doctype html><html lang="de"><head><meta charset="utf-8"><style>
    ...
    import { __ctoxTestHooks } from '/src/apps/business-os/modules/ctox/index.js?v=20260831-ctox-rubrik-slugs-v329';
    import { __businessChatTestInternals, crewCreatureHtml, syncCrewProceduralMotion } from '/src/apps/business-os/shared/business-chat.js?v=20260831-ctox-rubrik-slugs-v329';
