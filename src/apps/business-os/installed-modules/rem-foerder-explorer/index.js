...
export async function mount(ctx = {}) {
  ...
  root.innerHTML = '<div class="ctox-workspace ctox-workspace--three-pane rem-ctox-shell" data-rem-shell-version="1">' +
    ...
    '<main class="ctox-pane rem-ctox-main"><iframe class="rem-ctox-frame" title="FörderExplorer" sandbox="allow-scripts allow-same-origin allow-downloads allow-forms allow-modals allow-popups"></iframe></main>' +
  '</div>';

  const adapter = remCreatePersistenceAdapter(ctx, "rem-foerder-explorer");
