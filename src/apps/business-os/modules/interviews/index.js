...
const COPY = {
  de: {
    ...
    importLabel: 'Importieren', exportLabel: 'Exportieren', viewCards: 'Kachelansicht', viewList: 'Listenansicht',
  ...
  en: {
    ...
    importLabel: 'Import', exportLabel: 'Export', viewCards: 'Card view', viewList: 'List view',
