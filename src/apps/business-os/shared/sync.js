...
const MULTI_TAB_COORDINATOR_EPOCH = '20260829-browser-adapter-groups-v281';
...
export function createSyncRuntime({ db, config, onDiagnostic }) {
  ...
  const ensureMultiTabCoordinator = async () => {
    ...
    const rxdb = db?.rxdb || await import('../rxdb/dist/ctox-rxdb-js.mjs?v=20260829-outbound-adapter-schema-v201');
