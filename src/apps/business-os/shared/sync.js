...
const MULTI_TAB_COORDINATOR_EPOCH = '20260829-workjet-shell-responsive-header-v287';
...
export function createSyncRuntime({ db, config, onDiagnostic }) {
  ...
  const ensureMultiTabCoordinator = async () => {
    ...
    const rxdb = db?.rxdb || await import('../rxdb/dist/ctox-rxdb-js.mjs?v=20260829-workjet-outbound-schema-v202');
