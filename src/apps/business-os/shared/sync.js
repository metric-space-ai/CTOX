...
} from './sync-contract.js?v=20260831-ctox-desktopapp-ports-v328';
import { getBusinessOsCapabilityToken } from './command-bus.js?v=20260831-ctox-desktopapp-ports-v328';
...
const MULTI_TAB_COORDINATOR_EPOCH = '20260831-ctox-desktopapp-ports-v328';
...
export function createSyncRuntime({
  ...
  const ensureMultiTabCoordinator = async () => {
    ...
    const rxdb = db?.rxdb || await import('../rxdb/dist/ctox-rxdb-js.mjs?v=20260831-ctox-desktopapp-ports-v328');
