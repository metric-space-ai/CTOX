...
const MULTI_TAB_COORDINATOR_EPOCH = '20260828-release-isolated-leader-v273';
...
export function createSyncRuntime({ db, config, onDiagnostic }) {
  ...
  const ensureMultiTabCoordinator = async () => {
    ...
    const rxdb = db?.rxdb || await import('../rxdb/dist/ctox-rxdb-js.mjs?v=20260828-schema-only-token-v198');
