...
} from './sync-contract.js?v=20260831-ctox-crew-home-v325';
import { getBusinessOsCapabilityToken } from './command-bus.js?v=20260831-ctox-crew-home-v325';
...
const MULTI_TAB_COORDINATOR_EPOCH = '20260831-ctox-crew-home-v325';
...
export function createSyncRuntime({
  ...
  const ensureMultiTabCoordinator = async () => {
    ...
    const rxdb = db?.rxdb || await import('../rxdb/dist/ctox-rxdb-js.mjs?v=20260831-ctox-crew-home-v325');
