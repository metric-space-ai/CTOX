...
import { appReleaseProjection } from './app-lifecycle.js?v=20260831-shell-v2-unified-v324';
import {
  BusinessOsPermissions,
  canModifyBusinessModule,
  canUseBusinessPermission,
} from './permissions.js?v=20260831-shell-v2-unified-v324';
import {
  brandingExportJson,
  normalizeBrandingImportPayload,
  WORKSPACE_BRANDING_COLLECTION,
  WORKSPACE_BRANDING_DOCUMENT_ID,
} from './branding.js?v=20260831-shell-v2-unified-v324';
import {
  assignableRolesForActor,
  normalizeRole,
  roleCanManage,
  roleDisplayName,
} from './roles.js?v=20260831-shell-v2-unified-v324';
import { renderModuleWhyDiagnosticsHtml } from './shell-permissions-ui.js?v=20260831-shell-v2-unified-v324';
