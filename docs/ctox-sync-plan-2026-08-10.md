...
| P5 | **Batch-/Checkpoint-Matrix** — Browser 20/8/6/1 je Klasse vs. nativ uniform 20; Roundtrips dominieren; Deckel (16-KiB-Frame, 8-MiB-Transfer) sind bewusst | `sync-contract.js:48-68`; `rxdb_peer.rs:2579-2602`; `ctox-rxdb.md:468-510` | RPCs/MiB, Truncation-Rate, Zeit bis letzter Checkpoint, je Collection-Klasse | S (Messen) / M (adaptiv) |
