...
use mistralrs_core::{
    ...
    Request, RequestMessage, Response, ResponseOk, SamplingParams, SpeechGenerationRequest, Usage,
...
fn history_file_path() -> PathBuf {
    let proj_dirs = ProjectDirs::from("com", "", "ctox-engine")
    ...
    // e.g. ~/.config/ctox-engine/history.txt
