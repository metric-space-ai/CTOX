...
/// ```ignore
/// use either::Either;
/// use engine_server_core::openai::{Message, MessageContent};
///
/// // User message
...
#[derive(Debug, Clone, Deserialize, Serialize, ToSchema)]
#[serde(untagged)]
pub enum StopTokenIds {
    /// Multiple stop token ids
    Multi(Vec<u32>),
...
///
/// ```ignore
/// use engine_server_core::openai::Grammar;
///
...
pub struct ChatCompletionRequest {
    ...
    #[schema(example = json!(Option::None::<StopTokenIds>))]
    #[serde(default)]
    pub stop_token_ids: Option<StopTokenIds>,
    #[schema(example = 0.7)]
