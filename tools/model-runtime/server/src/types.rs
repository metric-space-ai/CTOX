//! ## Custom types used in engine.rs server core.

use std::sync::Arc;

use axum::extract::State;
use engine_core::{MistralRs, Pipeline};

/// This is the underlying instance of engine.rs.
...
///
/// ```no_run
/// use engine_core::ChatCompletionChunkResponse;
/// use engine_server_core::types::OnChunkCallback;
///
...
/// ```no_run
/// use engine_core::ChatCompletionChunkResponse;
/// use engine_server_core::types::OnDoneCallback;
///
