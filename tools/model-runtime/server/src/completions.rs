...
///
/// ```no_run
/// use engine_server_core::completions::CompletionOnChunkCallback;
///
...
///
/// ```no_run
/// use engine_server_core::completions::CompletionOnDoneCallback;
///
...
pub fn parse_request(
    ...
    let messages = if let Some(prompt_tokens) = oairequest.prompt_tokens {
        RequestMessage::CompletionTokens(prompt_tokens)
    } else {
