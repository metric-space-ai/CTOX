...
fn unigram_tokenizer(p: &PropsGGUF) -> Result<(Tokenizer, TokenizerKind)> {
    ...
    // https://github.com/EricLBuehler/engine.rs/pull/389#discussion_r1630620763
...
fn bpe_tokenizer(p: &PropsGGUF) -> Result<(Tokenizer, TokenizerKind)> {
    ...
    // https://github.com/EricLBuehler/engine.rs/pull/397#discussion_r1631988370
    let merges = p
        .merges
        .as_ref()
