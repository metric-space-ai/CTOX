...
/// https://engine.ai/news/mixtral-of-experts/
...
impl Attention {
    fn new(
        ...
        let kv_shard = engine_quant::compute_kv_shard(
...
impl BlockSparseTop2MLP {
    fn new(cfg: &Config, vb: ShardedVarBuilder, comm: &Arc<engine_quant::Comm>) -> Result<Self> {
        let hidden_sz = cfg.hidden_size;
