...
pub fn mla_decode_forward(
    ...
    kv_b_proj: &dyn engine_quant::QuantMethod,
    ...
    engine_paged_attn::concat_and_cache_mla(
        &ckv_flat,
        &k_pe_flat,
        key_cache,
        value_cache,
    ...
    let attn_latent = engine_paged_attn::flashinfer_mla_decode(
        &ql_nope,
        &q_pe,
        key_cache,
        value_cache,
...
pub fn mla_decode_forward(
    ...
    _kv_b_proj: &dyn engine_quant::QuantMethod,
...
pub fn mla_cache_forward(
    ...
    if !needs_prefix && attention_mask.is_some() {
        ...
        if total_prefix_tokens > 0 {
            ...
            let (ckv_prefix, kpe_prefix) = engine_paged_attn::gather_mla_cache(
                key_cache,
                value_cache,
                &block_tables_seq,
                &cu_seq_lens,
