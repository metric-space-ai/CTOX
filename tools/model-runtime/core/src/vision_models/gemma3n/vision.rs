...
use engine_quant::{Convolution, ShardedVarBuilder};
use tracing::warn;
...
impl VisionTower {
    pub fn new(vb: ShardedVarBuilder) -> Result<Self> {
        ...
        // https://github.com/EricLBuehler/engine.rs/issues/1592
...
See: https://github.com/EricLBuehler/engine.rs/issues/1592
