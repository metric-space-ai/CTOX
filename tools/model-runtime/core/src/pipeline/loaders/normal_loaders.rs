...
use crate::{
    attention::ATTENTION_CHUNK_SIZE, matformer::MatformerSliceConfig,
    utils::normal::RuntimeLoadPolicy,
};
use anyhow::Result;
...
use crate::{
    ...
    paged_attention::{
        AttentionImplementation, ModelConfigLike, ModelConfigMetadata, PagedCacheType,
    },
    pipeline::{
        isq::IsqModelLoader,
...
pub struct NormalLoadingMetadata {
    ...
    // Explicit PagedAttention cache type for this model load.
    pub paged_attn_cache_type: Option<PagedCacheType>,
    // Runtime policy carried explicitly from loader bootstrap.
    pub runtime_policy: RuntimeLoadPolicy,
...
impl FromStr for NormalLoaderType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            a => Err(format!("Unknown architecture `{a}`. Possible architectures: `engine`, `gemma`, `mixtral`, `llama`, `phi2`, `phi3`, `qwen2`, `gemma2`, `starcoder2`, `phi3.5moe`, `deepseekv2`, `deepseekv3`, `qwen3`, `glm4`, `glm4moelite`, `glm4moe`, `qwen3moe`, `smollm3`, `granitemoehybrid`, `gpt_oss`, `nemotron_h`, `qwen3next`.")),
        }
    }
}
...
///
/// [`NormalLoader`]: https://docs.rs/engine/latest/engine/struct.NormalLoader.html
