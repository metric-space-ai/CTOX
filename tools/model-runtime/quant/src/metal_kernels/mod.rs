...
#[cfg(target_os = "macos")]
const KERNELS: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/engine_quant.metallib"));
#[cfg(target_os = "ios")]
const KERNELS: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/engine_quant_ios.metallib"));
#[cfg(target_os = "tvos")]
const KERNELS: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/engine_quant_tvos.metallib"));
...
impl Kernels {
    ...
    #[allow(clippy::const_is_empty)] // KERNELS can be empty when ENGINE_METAL_PRECOMPILE=0
