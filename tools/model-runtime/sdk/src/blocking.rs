//! Synchronous (blocking) wrappers for the engine SDK.
//!
...
//! use engine::{IsqBits, TextModelBuilder, TextMessages, TextMessageRole};
//!
...
/// ```no_run
/// # use engine::blocking::{BlockingModel, BlockingStream};
/// # use engine::*;
