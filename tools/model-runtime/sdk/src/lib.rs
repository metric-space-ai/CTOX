//! # engine — Blazing-Fast LLM Inference in Rust
//!
//! The Rust SDK for [engine.rs](https://github.com/EricLBuehler/engine.rs), a high-performance
...
//!
//! ```no_run
//! use engine::blocking::BlockingModel;
//! use engine::{IsqBits, ModelBuilder};
//!
//! fn main() -> engine::error::Result<()> {
...
pub use engine_core::{McpClient, McpClientConfig, McpServerConfig, McpServerSource, McpToolInfo};
pub use engine_core::{SearchCallback, SearchResult, ToolCallback};
...
// ========== Request Types ==========
pub use engine_core::{Constraint, LlguidanceGrammar, MessageContent, NormalRequest, Request};

// ========== Sampling ==========
pub use engine_core::{DrySamplingParams, SamplingParams, StopTokens};
...
// ========== Audio Types ==========
pub use engine_core::AudioInput;

// ========== Custom Logits ==========
pub use engine_core::CustomLogitsProcessor;

// ========== Model Category ==========
pub use engine_core::ModelCategory;

// ========== Search Types ==========
pub use engine_core::{SearchEmbeddingModel, SearchFunctionParameters};

// ========== Speech Types ==========
pub use engine_core::{speech_utils, SpeechLoaderType};

// ========== AnyMoe Types ==========
pub use engine_core::{AnyMoeConfig, AnyMoeExpertType};
...
// ========== Speculative Types ==========
pub use engine_core::SpeculativeConfig;

// ========== Device Mapping ==========
pub use engine_core::{AutoDeviceMapParams, DeviceMapSetting};

// ========== Topology ==========
pub use engine_core::{LayerTopology, Topology};

// ========== Loader Types ==========
pub use engine_core::{NormalLoaderType, VisionLoaderType};

// ========== Token Source ==========
pub use engine_core::TokenSource;

// ========== Engine (Advanced) ==========
pub use engine_core::{IntervalLogger, MistralRs, RequestMessage, ResponseOk};

// ========== Utilities ==========
pub use engine_core::{initialize_logging, paged_attn_supported, parse_isq_value};

// ========== llguidance ==========
pub use engine_core::llguidance;

// Re-export the tool proc macro for ergonomic tool definition
pub use engine_macros::tool;
